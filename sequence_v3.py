...
def build_knn_shortlist(edge_maps, k=K_NEIGHBORS, distance_metric=DISTANCE_METRIC, image_folder=None):
    """
    ...
    if distance_metric == "edge_descript":
        ...
        # Edge descriptors
        print(f"  Computing edge descriptors for {n} images...")
        edge_descs = np.array([compute_edge_descriptor(edge_maps[fn]) for fn in filenames])
...
def build_sparse_cost_matrix(edge_maps, max_workers=None, k=K_NEIGHBORS, image_folder=None):
    """
